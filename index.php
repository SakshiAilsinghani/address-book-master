<?php
// when we uplaod files we have to use encryption type ie. enctype. 
// why ? 
// get and post are the methds of http. For secured data use Post.
// a href - get method is used.
// headers are never encrypted.
// payloads are encrypted so USE POST.
// whenever we normally request for redirecting it uses get method .
...
<body>
        ...
        <div class="col s12">
            <table class="highlight centered">
                ...
                <tbody>
                    ...
                    // 0 - 5 records - *FOR PAGE 1* start from zeroth record and take 5 records
                    // 5 - 5 records - *FOR PAGE 2* start from fifth record and take 5 records
                    // so formula for starting record is written just below , and no of records are constant.
                    $start = ($page-1) * $num_of_records_per_page;

                    $query = "SELECT count(*) as total_records FROM contacts";
                    // db_select will return 2D array ie.rows.
    ...
    <div class="row">
        <div class="col s12">
            <ul class="pagination">
                <li class="<?= $page==1 ? 'disabled' : 'waves-effect'; ?>"><a href="?page=<?=$prev_page_num;  ?>">
                ...
                <li class=" <?= $pages==$total_pages ? 'disabled' : 'waves-effect'; ?>"><a href="?page=<?=$next_page_num; ?>"><i class="material-icons">chevron_right</i></a></li>
            </ul>
        </div>
    </div>
    <!-- /Pagination -->
    ...
    <div id="deleteModal" class="modal">
        ...
        <div class="modal-footer">
            ...
            <a href="delete.php" id="deleteModalAgreeButton" class="modal-close btn waves-effect red lighten-2">Agree</a>
        </div>
    </div>
    <!-- /Delete Modal Structure -->
    <!--JQuery Library-->
