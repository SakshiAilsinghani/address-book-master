...
if(isset($_POST['action'])){
    ...
    if($_FILES['pic']){
        ...
        $image_name = "$first_name_lower-$last_name_lower.$ext";
        ...
        $error_flag = true;
        $error_flag= "Image is compulsory";
    }
...
if(!$error_flag){
$query = "INSERT INTO contacts(first_name, last_name, email, birthdate, telephone,address,image_name) VALUES 
('$first_name','$last_name','$email','$birthdate','$telephone', '$address', '$image_name')";
            ...
            <form class="col s12 formValidate" action="" id="add-contact-form" method="POST" enctype="multipart/form-data">
                <div class="row mb10">
                    <div class="input-field col s6">
                        <input id="first_name" value="<?= getoldValue($_POST,'first_name')?>" name="first_name" type="text" class="validate" data-error=".first_name_error">
                        <label for="first_name">First Name</label>
                        <div class="first_name_error "></div>
                    </div>
                    <div class="input-field col s6">
                        <input id="last_name" value="<?= getoldValue($_POST,'last_name')?> "name="last_name" type="text" class="validate" data-error=".last_name_error">
                ...
                <div class="row mb10">
                    <div class="input-field col s6">
                        <input id="email" value="<?= getoldValue($_POST,'email')?>" name="email" type="email" class="validate" data-error=".email_error">
                        <label for="email">Email</label>
                        <div class="email_error "></div>
                    </div>
                    <div class="input-field col s6">
                        <input id="birthdate"value="<?= getoldValue($_POST,'birthdate')?>" name="birthdate" type="text" class="datepicker" data-error=".birthday_error">
                ...
                <div class="row mb10">
                    <div class="input-field col s12">
                        <input id="telephone" value="<?= getoldValue($_POST,'telephone')?>" name="telephone" type="tel" class="validate" data-error=".telephone_error">
                ...
                <div class="row mb10">
                    <div class="input-field col s12">
                        <textarea id="address"value="<?= getoldValue($_POST,'address')?>" name="address" class="materialize-textarea" data-error=".address_error"></textarea>
